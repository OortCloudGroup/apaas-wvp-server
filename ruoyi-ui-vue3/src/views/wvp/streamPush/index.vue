<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="推流状态" align="center">
      ...
      <el-table-column label="位置信息" align="center" show-overflow-tooltip>
        <template #default="scope">
          <span
        ...
        <template #default="scope">
          <div class="operateAppBox flexRowAC" style="justify-content: flex-end;">
            <div
              ...
              @click.stop="playPush(scope.row)"
              v-hasPermi="['wvp:push:play']"
            >
            ...
            <el-dropdown
              ...
              v-if="checkPermi(['wvp:channel:edit', 'wvp:push:edit', 'wvp:push:remove', 'wvp:record:list'])"
            >
              ...
              <template #dropdown>
                <el-dropdown-menu>
                  ...
                  <el-dropdown-item command="handleEdit" v-if="checkPermi(['wvp:push:edit'])">
                    编辑
                  </el-dropdown-item>
                  <el-dropdown-item command="handleDelete" style="color: #f56c6c" v-if="checkPermi(['wvp:push:remove'])">
                    删除
                  </el-dropdown-item>
